...
public class JsonData {
    public static String POST_INFO = "{" +
            "{\"post\":{\"title\":\"What kind questions can I ask in the AMA meeting?\"," +
